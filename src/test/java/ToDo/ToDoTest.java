...
class ToDoTest {
    ...
    @Test
    void getTitle() {
        ToDo test = new ToDo("Test", "This is a test", new GregorianCalendar(2021, Calendar.MARCH, 27), true, "David" );
    ...
    void getDueDate() {
        ToDo test = new ToDo("Test", "This is a test", new GregorianCalendar(2021,Calendar.MARCH, 27), true, "David" );
        assertEquals(new GregorianCalendar(2021, Calendar.MARCH, 27), test.getDueDate());
    }

    @Test
    void setDueDate() {
        ToDo test = new ToDo("Test", "This is a test", new GregorianCalendar(2021,Calendar.MARCH, 27), true, "David" );
        test.setDueDate(new GregorianCalendar(2022, Calendar.MARCH, 27));
        assertEquals(new GregorianCalendar(2022,Calendar.MARCH, 27), test.getDueDate());
    }
